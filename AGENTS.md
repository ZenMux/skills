...
This is the ZenMux skills repository — a collection of Codex skills for working with ZenMux, an LLM API aggregation service. Skills here help Codex answer questions about ZenMux by reading its official documentation.

## Architecture

```
skills/                      # Codex skills (each skill = a directory)
...
Step-by-step workflow instructions for Codex...
```
